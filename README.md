...
- `lang` : language of tweets to be retrieved, given in ISO 639-1 format. A Wikipedia list can be found here ("https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes").
